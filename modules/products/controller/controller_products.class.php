...
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_pagination/modules/products/utils/functions_products.inc.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_pagination/utils/upload.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_pagination/utils/common.inc.php");
$path = $_SERVER['DOCUMENT_ROOT'] . '/products_ORM_pagination/';
